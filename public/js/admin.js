// Conecte assim que abrir a página, então vai ficar assim:
const socket = io();
...
socket.on("admin_list_all_users", (connections) => {
    ...
    // "" (vazio) para cada nova conexão não duplicar no list_user
...
function call(id) {
    // find percorre array até achar um que a condição é verdadeira, e retorna o primeiro objeto
